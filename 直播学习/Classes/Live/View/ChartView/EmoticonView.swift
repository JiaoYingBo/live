...
extension EmoticonView {
    fileprivate func setupUI() {
        ...
        let pageCollectionView = STPageCollectionView(frame: bounds, titles: ["普通", "粉丝专属"], style: style, isTitleInTop: false, layout: layout)
...
extension EmoticonView : STPageCollectionViewDataSource {
...
extension EmoticonView : STPageCollectionViewDelegate {
